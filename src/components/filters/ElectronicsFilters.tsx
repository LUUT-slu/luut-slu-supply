...
const TARGET_OPTIONS = ['Storage', 'Color', 'Brand', 'Condition'];
const TAG_KEYS = ['brand', 'condition', 'storage'];

export function ElectronicsFilters({ products, values, onChange }: FilterPanelProps) {
